...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        """
         responsible for data transformation based on the numerical and categorical features
        """
        try:
            numerical_features = ['reading score',
                                  'writing score']
            ...
            cat_pipeline = Pipeline(
                steps= [
                    ...
                    ('one hot encoder',OneHotEncoder()), #could use alternative scalers i.e target, k fold target enfolding
